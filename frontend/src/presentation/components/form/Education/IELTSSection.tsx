...
interface IELTSSectionProps {
  ieltsDate: string;
  setIeltsDate: (v: string) => void;
  ieltsOverall: string;
  setIeltsOverall: (v: string) => void;
  ieltsReading: string;
  setIeltsReading: (v: string) => void;
  ieltsWriting: string;
  setIeltsWriting: (v: string) => void;
}

const IELTSSection: React.FC<IELTSSectionProps> = ({
  ieltsDate, setIeltsDate,
  ieltsOverall, setIeltsOverall,
  ieltsReading, setIeltsReading,
  ieltsWriting, setIeltsWriting
}) => (
