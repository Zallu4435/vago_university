...
const ProgramCard: React.FC<ProgramCardProps> = ({ title, description, image, courses, comingSoon }) => {
  return (
    <div className="bg-white rounded-lg sm:rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 border border-cyan-100 transform hover:-translate-y-1">
      <div
        className="w-full h-40 sm:h-48 lg:h-56 bg-gradient-to-r from-cyan-600 to-blue-600 relative group overflow-hidden"
      >
        {!comingSoon ? (
          <>
            <img
      ...
      {!comingSoon ? (
        <div className="p-4 sm:p-6">
          ...
          <button className="mt-3 sm:mt-4 text-cyan-600 hover:text-cyan-700 flex items-center group font-medium text-sm sm:text-base">
            Learn more 
...
const UndergraduateProgrammes: React.FC = () => {
  const programs = [
    {
  ...
  return (
    <section className="w-full bg-gradient-to-b from-cyan-50 via-white to-cyan-50 py-8 sm:py-12 lg:py-20">
      <div className="max-w-6xl mx-auto px-3 sm:px-4 lg:px-6">
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-cyan-600 max-w-3xl mx-auto mb-6 sm:mb-8 px-2">
            Our programmes are designed to offer deep knowledge while encouraging interdisciplinary exploration. 
            Unleash your imagination and thirst for learning.
          </p>
