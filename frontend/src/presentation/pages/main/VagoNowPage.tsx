...
export const VagoNowPage: React.FC = () => {
  ...
  // Get VAGO Now items with server-side filtering using debounced search
        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">VAGO Now</h1>
                <p className="text-sm text-gray-600">Discover our exciting and vibrant campus life</p>
              </div>
            </div>
