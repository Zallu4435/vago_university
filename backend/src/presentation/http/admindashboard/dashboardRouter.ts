...
router.get('/metrics', (req, res, next) => 
  expressAdapter(req, res, next, adminDashboardController.adminDashboardController.getDashboardMetrics.bind(adminDashboardController.adminDashboardController))
);

router.get('/user-growth', (req, res, next) => 
  expressAdapter(req, res, next, adminDashboardController.adminDashboardController.getUserGrowthData.bind(adminDashboardController.adminDashboardController))
);

router.get('/revenue', (req, res, next) => 
  expressAdapter(req, res, next, adminDashboardController.adminDashboardController.getRevenueData.bind(adminDashboardController.adminDashboardController))
);

router.get('/performance', (req, res, next) => 
  expressAdapter(req, res, next, adminDashboardController.adminDashboardController.getPerformanceData.bind(adminDashboardController.adminDashboardController))
);

router.get('/activities', (req, res, next) => 
  expressAdapter(req, res, next, adminDashboardController.adminDashboardController.getRecentActivities.bind(adminDashboardController.adminDashboardController))
);

router.get('/alerts', (req, res, next) => 
  expressAdapter(req, res, next, adminDashboardController.adminDashboardController.getSystemAlerts.bind(adminDashboardController.adminDashboardController))
);
