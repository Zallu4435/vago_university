            ...
            >
              ...
              <div
                className={`absolute -inset-0.5 bg-gradient-to-r ${
                  cls.status === 'Live'
                    ? 'from-red-200/0 to-orange-200/0 group-hover/item:from-red-200/20 group-hover/item:to-orange-200/20'
                  ...
                  <div className="flex items-center space-x-3 mb-2">
                    <div
                      className={`w-2 h-2 rounded-full ${
                        cls.status === 'Live' ? 'bg-red-400 animate-pulse' : 'bg-gradient-to-br from-orange-400 to-amber-500'
                      }`}
                    ></div>
