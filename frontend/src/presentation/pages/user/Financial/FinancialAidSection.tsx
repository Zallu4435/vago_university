          ...
          <div className="mt-4">
            {!showApplicationForm ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-orange-800 font-medium mb-1">Application Type:</label>
                  <select
                ...
                <div>
                  <label className="block text-orange-800 font-medium mb-1">Amount Requested ($):</label>
                  <input
                    type="number"
                    value={amount}
                  ...
                  {applications.map((application) => (
                    <div key={application.id} className="border border-amber-200 rounded-lg p-4">
                      <div className="flex justify-between items-start">
                        <div>
                          <h6 className="font-medium text-orange-800">{application.type}</h6>
                          <p className="text-gray-600">Amount: ${application.amount.toLocaleString()}</p>
                          <p className="text-gray-600">Term: {application.term}</p>
                        </div>
