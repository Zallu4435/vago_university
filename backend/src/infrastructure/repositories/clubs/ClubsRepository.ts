    ...
    async createClub(params: CreateClubRequestDTO): Promise<CreateClubResponseDTO> {
      ...
      return {
        club: new Club({
          ...
          status: newClub.status as ClubStatus,
          members: newClub.members ? [newClub.members] : [],
          color: newClub.color,
          icon: newClub.icon,
    ...
    async updateClub(params: UpdateClubRequestDTO): Promise<UpdateClubResponseDTO | null> {
      ...
      return {
        club: new Club({
          ...
          status: updatedClub.status as ClubStatus,
          members: updatedClub.members ? [updatedClub.members] : [],
