...
export class EnquiryController implements IEnquiryController {
  ...
  constructor(
    ...
    private getEnquiriesUseCase: GetEnquiriesUseCase,
    private getEnquiryByIdUseCase: GetEnquiryByIdUseCase,
    private updateEnquiryStatusUseCase: UpdateEnquiryStatusUseCase,
    private deleteEnquiryUseCase: DeleteEnquiryUseCase,
    private sendEnquiryReplyUseCase: SendEnquiryReplyUseCase
  ) {
